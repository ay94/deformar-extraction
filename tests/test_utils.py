...
from experiment_utils.utils import (  # Import classes from your utility file
...
def test_create_filename(file_handler):
    ...
    assert (
        file_handler.create_filename(filename) == expected_path
    ), "Filename creation did not construct the correct path."
